        ...
        <div class="row d-flex d-xl-flex justify-content-center justify-content-xl-center">
            <div class="col-sm-12 col-lg-10 col-xl-9 col-xxl-7 bg-white shadow-lg" style="border-radius: 5px;">
                <div class="p-5">
                    ...
                    <form class="user" action="/adminedituserprofile" method="post">
                        ...
                        <div class="mb-3">账户余额：</div>
                        <div class="mb-3"><input class="form-control form-control-user" type="number"
                                                 name="targetnewuserbalance" value="${items.userbalance}"
                                                 placeholder="请输入账户余额"></div>
                        <button class="btn btn-primary d-block btn-user w-100" id="submitBtn" type="submit" onClick="return confirm('确定修改吗?');">修改
                        </button>
                    </form>
